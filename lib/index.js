...
const
    ...
    ISOLATION_NOWAIT_REPEATABLE_READ = [isc_tpb_version3, isc_tpb_write, isc_tpb_nowait, isc_tpb_concurrency];
...
exports.ISOLATION_NOWAIT_REPEATABLE_READ = ISOLATION_NOWAIT_REPEATABLE_READ;
...
Connection.prototype.startTransaction = function (isolation, callback) {
    ...
    blr.addBytes(isolation || ISOLATION_NOWAIT_REPEATABLE_READ);
